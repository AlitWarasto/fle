...
<section id="s3">
  <div class="container">
    <div class="row">
      <h3 class="col-md-12 h1 font-weight-bolder cRed text-center mt-3 mb-3">Financial Literacy Express</h3>
      <h4 class="col-md-12 h2 font-weight-bolder cGrey text-center mt-1 mb-1">Solusi Belajar Finance, KILAT!</h4>
      <p class="col-md-12 h4 font-weight-bolder cGrey text-center mt-1 mb-3">Sekarang waktunya belajar <span class="cRed font-weight-bold">F.L.E Digital</span> <b>connected from anywhere</b></p>
      <div class="col-md-4">
      ...
      <div class="col-md-4">
        ...
        <div class="col-md-12">
          ...
          <p class="cGrey small">Jangan khawatir, Asisten F.L.E siap mendampingi Anda mengerjakan materi F.L.E Digital.</p>
        </div>
      </div>
    </div>
  </div>
...
<section id="s6">
  <div class="container">
    <div class="row">
      <h3 class="col-md-12 text-center mt-3 mb-3 font-weight-bolder fPoppins">Untuk Siapa F.L.E Digital <span class="cRed">F.L.E Digital</span> ini dibuat?</h3>
      <div class="col-md-3">
    ...
    <div class="row">
      ...
      <div class="mt-5 row">
        ...
        <div class="col-md-6 box">
          ...
          <a class="row justify-content-center" href="https://member.fledigital.com/product/ecourse-fle-digital/"><btn class="btn btn-primary pt-3 pb-3 pr-4 pl-4 fs20" role="button"> Gabung Sekarang</btn></a>
...
<section id="s9" class="pb6">
  <div class="container">
    <div class="row">
      <h2 class="col fPoppins font-weight-bolder text-center mb-5 mt-5">Kerugian jika Anda tidak segera belajar <span class="cRed">F.L.E Digital</span> sekarang juga</h2>
